...
$sql_ins="INSERT into $get (month,fees,balance,advance) VALUES('$mon','$fee','$bal','$adv')";
		...
		$start=$page*$perpage-$perpage;
			...
			$sql_pg="SELECT * FROM $get LIMIT $start,$perpage";
...
<div class="main">
		...
		<div class="sub">
			<a href="edit.php?month=<?php echo $_SESSION['mons'] ?>
					 &fees=<?php echo $_SESSION['fees'] ?>
					 &bals=<?php echo $_SESSION['bals'] ?>
					 &advs=<?php echo $_SESSION['advs'] ?>
					 ">update</a></div>
		</div>
	<?php }
